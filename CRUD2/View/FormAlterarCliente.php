...
.btnLogin:active
{
    ...
    <?php
        ...
        ?>
    <body>
        <form id="formulario" METHOD="POST" ACTION="../Controlador/alterarClienteController.php">
            ...
            <table>
                ...
                <tr><td> <input type="text" name="nome" id="nome"  value="<?php echo $cliente["nome"]?>"></td></tr>
                <tr><td><label>Sobrenome:</label></td></tr>
                <tr><td><input type="text" name="sobrenome" id="sobrenome" value="<?php echo $cliente["sobrenome"]?>"></td></tr>      
                <tr><td>Sexo:</td></tr>
                <tr><td><?php
                ...
                <tr><td>Data de Nascimento:</td><tr><td><select name="DNdia">
                            <option selected/><?php echo $cliente["DNdia"]?></option>
                <option>Dia</option>
                <?php
                for($i =1; $i < 32; $i++){
                ...
                <select name="DNmes">
                    <option selected/><?php echo $cliente["DNmes"]?></option>
                <option>Mês</option>
                <option>Jan</option>
                <option>Fev</option>
                <option>Mar</option>
                ...
                <select name="DNano">
                    <option selected/><?php echo $cliente["DNano"]?></option>
                <option>Ano</option>
                <?php
                for($a =2015; $a > 1900; $a--){
                ...
                <tr><td><input type="text" name="cpf" id="cpf" value="<?php echo $cliente["cpf"]?>"></td></tr>
                <tr><td><label>Cep:</label></td></tr>
                <tr><td><input type="text" name="cep" id="cep" value="<?php echo $cliente["cep"]?>"></td> </tr>
                <tr><td><label>Rua:</label></td></tr>
                <tr><td><input type="text" name="rua" id="rua"  value="<?php echo $cliente["rua"]?>"></td>  </tr>
                <tr><td><label>Número:</label></td></tr>
                <tr><td><input type="text" name="numero" id="numero"  value="<?php echo $cliente["numero"]?>"></td></tr>
                <tr><td><label>Bairro:</label></td></tr>
                <tr><td><input type="text" name="bairro" id="bairro"  value="<?php echo $cliente["bairro"]?>"></td>  </tr>
                <tr><td><label>Cidade:</label></td></tr></tr>
                <tr><td><input type="text" name="cidade" id="cidade"  value="<?php echo $cliente["cidade"]?>"></td></tr></tr>
                <tr><td><label>Estado:</label></td></tr></tr>
                <td><input type="text" name="estado" id="estado"  value="<?php echo $cliente["estado"]?>"></td></tr>  </tr>      
                <tr><td><label>Email:</label></td></tr>
                 <tr><td> <input type="text" name="email"  value="<?php echo $cliente["email"]?>"></td></tr>
               
            </table>
                
        <table>
            <tr><td><label>Login:</label></td></tr>
            <tr><td> <input type="text" name="login" id="login"  value="<?php echo $cliente["login"]?>"></td></tr>
            <tr><td><label>Senha:</label></td></tr>
            <tr><td> <input type="password" name="senha" id="senha" value="<?php echo $cliente["senha"]?>"></td></tr>
            <tr><td>Objetivo:</td><tr><td><select name="objetivo" id="objetivo" >
                        <option selected/><?php echo $cliente["objetivo"]?></option>
            ...
            <option>Mais Energia & resistencia </option> 
                  ...
                  <td>&nbsp;</td>
                    <td><a href="ListAllCliente.php"><input type="button" class="btnLogin" value="Voltar"/></a></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <?php
